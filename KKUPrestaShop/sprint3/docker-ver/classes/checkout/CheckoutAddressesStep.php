...
class CheckoutAddressesStepCore extends AbstractCheckoutStep
{
    ...
    public function __construct(
        ...
        bool $taxInvoiceNeeded = false
    ) {
        parent::__construct($context, $translator);
        $this->addressForm = $addressForm;
        $this->taxInvoiceNeeded = $taxInvoiceNeeded;
    }
    ...
    public function handleRequest(array $requestParams = [])
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            // Retrieve value of TaxInvoiceNeeded from form submission
        ...
        if ($controller instanceof OrderController) {
            ...
            $params = array_replace(
                ...
                [
                    ...
                    'use_same_address' => $this->use_same_address,
                    'tax_invoice_needed' => $this->taxInvoiceNeeded,
                ],
                $errors
            );
        }
