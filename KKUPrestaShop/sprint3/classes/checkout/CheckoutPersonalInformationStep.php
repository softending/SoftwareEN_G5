...
class CheckoutPersonalInformationStepCore extends AbstractCheckoutStep
{
    ...
    private $taxInvoiceNeeded = false;
    ...
    public function handleRequest(array $requestParameters = [])
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['TaxInvoiceNeeded'])) {
            $this->taxInvoiceNeeded = $_POST['TaxInvoiceNeeded'] === 'true';
            // You can store the $taxInvoiceNeeded value in session or database if needed
        }
    ...
    public function render(array $extraParams = [])
    {
        return $this->renderTemplate(
            ...
            [
                ...
                'taxInvoiceNeeded' => $this->taxInvoiceNeeded,
            ]
        );
    }
}
