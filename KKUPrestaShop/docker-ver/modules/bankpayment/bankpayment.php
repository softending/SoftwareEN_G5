...
class bankpayment extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = $this->l('Bank payment');
    ...
    public function hookDisplayPaymentReturn()
    {
        ...
        return $this->fetch('module:bankpayment/views/templates/hook/return.tpl');
    }
    ...
    public function hookPaymentOptions()
    {
        ...
        $OnlinePaymentOption->setModuleName($this->name)
                ...
                ->setAdditionalInformation($this->fetch('module:bankpayment/views/templates/hook/onlinepayment_intro.tpl'));
    ...
    public function getContent()
    {
        ...
        return $this->fetch('module:bankpayment/views/templates/admin/configure.tpl');
    }
}
