...
class ClassicThemeStylesheetCompiler implements ThemeStylesheetCompilerInterface
{
    ...
    {
        try {
            $content = file_get_contents($this->modulePath . self::COMPILABLE_FILES_DIRECTORY . '/theme.scss');
    ...
    {
        $manifestFile = file_get_contents($this->modulePath . self::COMPILABLE_FILES_DIRECTORY . DIRECTORY_SEPARATOR . self::MANIFEST_FILE_NAME);
