...
class FontDataProvider
{
    ...
    public function saveFontDataIntoTemporaryFolder(string $response): void
    {
        ...
        $fontData = file_get_contents($url[1]);
    ...
    {
        $font = file_get_contents($this->modulePath . 'default_fonts.json');
    ...
    {
        $font_variants = file_get_contents($this->modulePath . 'font_variants.json');
