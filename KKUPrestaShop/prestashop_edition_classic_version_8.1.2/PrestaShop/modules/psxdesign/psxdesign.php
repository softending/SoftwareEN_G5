...
use PrestaShop\Module\PsxDesign\Install\Database\DatabaseTablesInstaller;
use PrestaShop\Module\PsxDesign\Install\Database\DatabaseTablesUninstaller;
...
class PsxDesign extends Module
{
    ...
    public function install(): bool
    {
        ...
        return parent::install() &&
            (new DatabaseTablesInstaller($this->getLocalPath()))->install() &&
    ...
    public function uninstall(): bool
    {
        ...
        return parent::uninstall() &&
            ...
            (new DatabaseTablesUninstaller($this->getLocalPath()))->uninstall() &&
