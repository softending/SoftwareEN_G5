...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
  ...
  <thead>
  <tr>
    <th class="product header small" width="31.5%">{l s='Product' d='Shop.Pdf' pdf='true'}</th>
    {if $isTaxEnabled}
      <th class="product header small" width="31.5%">{l s='Tax Rate' d='Shop.Pdf' pdf='true'}</th>
    {/if}
